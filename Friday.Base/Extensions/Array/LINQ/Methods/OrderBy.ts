...
Array.prototype.OrderBy = function <TKey extends (Friday.System.IComparable<any> | number | string)>(keySelector: Selector<any, TKey>): Array<any> {
    return this.sort((a: Friday.System.IComparable<any>, b: Friday.System.IComparable<any>) => {
        let aKey = keySelector(a) as any;
        let bKey = keySelector(b) as any;

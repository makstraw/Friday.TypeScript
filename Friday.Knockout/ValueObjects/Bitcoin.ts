...
//    export class Bitcoin {
//        private _satoshiAmount: number;
//
//        protected get satoshiAmount(): number {
//            return this._satoshiAmount;
//        }
//
//        protected set satoshiAmount(newValue: number) {
//            this._satoshiAmount = newValue;
//        }
//
//        constructor(satoshiAmount: number) {
//            this.satoshiAmount = parseInt(satoshiAmount.toFixed(0));
...
//        }
//
//        public Set(value: Bitcoin) {
//            this.satoshiAmount = value.ToSatoshi();
//        }
//    }
//
//    export class KoBitcoin extends Bitcoin {
//        private _koSatoshiAmount: KnockoutObservable<number> = ko.observable(0);
//
//        protected get satoshiAmount(): number {
//            return this._koSatoshiAmount();
//        }
//
//        protected set satoshiAmount(newValue: number) {
//            this._koSatoshiAmount(newValue);
//        }
//
//        public Set(value: Bitcoin, forceNotify = false) {
//            super.Set(value);
//            if (forceNotify) this._koSatoshiAmount.notifySubscribers(this.satoshiAmount);
//        }
//
//
//        public Step: KnockoutComputed<number> = ko.pureComputed((): number => 1 / Bitcoin.getMultiplier(Bitcoin.DefaultMultiplier().Name()));
